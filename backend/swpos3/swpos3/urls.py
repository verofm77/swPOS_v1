...
schema_view = get_schema_view(
   openapi.Info(
      title="swpos3 - apiDoc",
      default_version='v1',
      description="Documentación de la api de swpos3",
      terms_of_service="verofm77@gmail.com",
      contact=openapi.Contact(email="verofm77@gmail.com"),
